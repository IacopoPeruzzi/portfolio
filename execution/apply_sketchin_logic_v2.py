    ...
    <div className="container">
      ...
      <div className="grid-2" style={{marginTop: '100px'}}>
        {initiatives.map(item => (
          <Link key={item.id} to={`/case-study/${item.id}`} className="card reveal" style={{display: 'block', textDecoration: 'none', color: 'inherit'}}>
  ...
  <section className="section" id="projects">
    <div className="container">
      ...
      <div className="grid-3" style={{marginTop: '100px'}}>
        {projects.map(p => (
          <Link key={p.id} to={`/case-study/${p.id}`} className="card reveal" style={{padding: '40px', display: 'block', textDecoration: 'none', color: 'inherit'}}>
...
''')
    ...
    print("Dynamic layout and animations applied successfully!")
